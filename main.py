...
# Sound
mixer.music.load("326660__150128__spaceship-variations.wav")
mixer.music.play(-1)
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('chick (1).zip'))
...
while running:
    ...
    for i in range(num_of_enemies):
        ...
        if collision:
            explosionSound = mixer.Sound("342566__inspectorj__sewer-soundscape-a.wav")
            explosionSound.play()
            bulletY = 480
            bullet_state = "ready"
            score_value += 1
